...
app = FastAPI(
    ...
    version="1.0.0",
    docs_url="/docs",
    redoc_url=None  # Desabilita ReDoc para melhor performance
)
...
app.add_middleware(
    SessionMiddleware,
    secret_key=secrets.token_hex(32)  # Use uma chave secreta segura
)
...
{{
"introduction": "Análise resumida do currículo de [nome] para as vagas de [cargo]. 
"extracted_keywords": {{
"all_keywords": [
...
IMPORTANTE:
- Na introdução, faça uma análise resumida da adequação do perfil e indique pontos positivos e de melhoria.
- Extraia TODAS as palavras-chave das vagas EXATAMENTE como aparecem
- Compare com o currículo usando correspondência EXATA das palavras-chave.
